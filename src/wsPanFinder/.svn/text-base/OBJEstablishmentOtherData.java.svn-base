...
/**
 * <p>
 * Java class for OBJ_EstablishmentOtherData complex type.
 * 
 * <p>
...
@XmlType(name = "OBJ_EstablishmentOtherData", propOrder = { "id",
		"openAllyear", "openJanuary", "openFebruary", "openMarch", "openApril",
		"openMay", "openJune", "openJuly", "openAugust", "openSeptember",
		"openOctober", "openNovember", "openDecember", "open24Hours",
		"open24HoursComment", "employeeAmount", "cashRegisterAmount",
		"scanners", "wicAuthorized", "wiCid", "wicDenied", "wicDeniedReason" })
