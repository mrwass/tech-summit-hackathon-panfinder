...
/**
 * <p>
 * Java class for ArrayOfOBJ_EstablishmentService complex type.
 * 
 * <p>
...
@XmlType(name = "ArrayOfOBJ_EstablishmentService", propOrder = { "objEstablishmentService" })
public class ArrayOfOBJEstablishmentService {
	 ...
	 * <CODE>set</CODE> method for the objEstablishmentService property.
	 * 
	 * <p>
