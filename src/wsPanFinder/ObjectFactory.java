 ...
 * element interface generated in the wsPanFinder package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _ArrayOfOBJEstablishment_QNAME = new QName(
			"http://tempuri.org/", "ArrayOfOBJ_Establishment");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: wsPanFinder
	 * 
	 */
	 ...
	 * {@link ArrayOfOBJEstablishment }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://tempuri.org/", name = "ArrayOfOBJ_Establishment")
	public JAXBElement<ArrayOfOBJEstablishment> createArrayOfOBJEstablishment(
			ArrayOfOBJEstablishment value) {
		return new JAXBElement<ArrayOfOBJEstablishment>(
				_ArrayOfOBJEstablishment_QNAME, ArrayOfOBJEstablishment.class,
				null, value);
	}
